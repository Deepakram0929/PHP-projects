  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">Deepaktranspots@gmail.com</a>
        <i class="fa fa-phone"></i>  
        <a href="#" data-toggle="modal" data-target="#developer">+ 91 9449918899</a>
    ...
    <section id="portfolio" class="wow fadeInUp">
      ...
      <div class="container-fluid">
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="img/chamundeshwari-temple-mysuru.jpg" class="portfolio-popup">
                <img src="img/chamundeshwari-temple-mysuru.jpg" alt=""style="height:350px;">
                <div class="portfolio-overlay">
                  <div class="portfolio-info"><h2 class="wow fadeInUp"></h2></div>
                </div>
              </a>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="img/mysore-palace-illuminated.jpg" class="portfolio-popup">
                <img src="img/mysore-palace-illuminated.jpg" alt=""style="height:350px;">
                <div class="portfolio-overlay">
                  <div class="portfolio-info"><h2 class="wow fadeInUp"></h2></div>
                </div>
              </a>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="#">Deepakram Bus Transport</a>
      </div>
    </div>
  </footer><!-- #footer -->
